...
public class FileUploadController {
    ...
    @Operation(summary = "파일 업로드용 Presigned URL 생성", description = "S3 파일 업로드를 위한 presigned URL을 생성합니다. 이미지(jpeg, jpg, png, gif, webp) 및 영상(mp4, avi, mov, wmv, flv, webm) 파일을 지원합니다. presignedUrl에 반환 받은 imageURL을 업로드 해주세요. (presigned URL은 15분 후 자동으로 만료됩니다.)")
